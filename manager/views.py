    ...
    def list(self, request):
        ...
        try:
            if not (request.user.role in ['MANAGER'] or request.user.is_superuser):
                return Response({
                    "error": "Unauthorized",
                    "details": "Only MANAGER can view assigned engineers"
            ...
            return Response({
                "error": "Error retrieving engineers",
                "details": str(e)
    ...
    def list(self, request):
        ...
        try:
            if not (request.user.role in ['MANAGER'] or request.user.is_superuser):
                return Response({
                    "error": "Unauthorized",
                    "details": "Only MANAGER can view assigned meters"
                }, status=status.HTTP_403_FORBIDDEN)
    ...
    def create(self, request):
        ...
        try:
            if not (request.user.role in ['MANAGER'] or request.user.is_superuser):
                return Response({
                    "error": "Unauthorized",
                    "details": "Only MANAGER can assign meters to engineers"
                }, status=status.HTTP_403_FORBIDDEN)
            ...
            if not meter or not engineer:
                return Response({
                    "error": "Not found",
                    "details": "Meter or engineer not found"
            ...
            if not engineer_manager_assignment:
                return Response({
                    ...
                    "details": "Engineer is not assigned to the user"
            ...
            if not meter_assignment:
                return Response({
                    "error": "Invalid assignment",
                    "details": "Meter is not assigned to the user"
                }, status=status.HTTP_400_BAD_REQUEST)
    ...
    def delete(self, request):
        ...
        try:
            if not (request.user.role in ['MANAGER'] or request.user.is_superuser):
                return Response({
                    "error": "Unauthorized",
                    "details": "Only MANAGER can delete meters from engineers"
                }, status=status.HTTP_403_FORBIDDEN)
